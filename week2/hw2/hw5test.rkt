...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (ifgreater (int 1) (int 4) (int 3) (int 2)))
                 (int 2) "ifgreater (e2 > e1)")
   (check-equal? (eval-exp (ifgreater (int 12) (int 2) (int 6) (int 5)))
                 (int 6) "ifgreater (e1 > e2)")

   ;; mlet test
   ;; 
   (check-equal? (eval-exp (mlet "x" (int 1) ;var, e
                                 (add (int 5)(var "x")))) ;body
                 (int 6) "mlet test")
